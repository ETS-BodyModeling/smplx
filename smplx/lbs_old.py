...
# read_dictionary = np.load('/content/drive/MyDrive/Recherche_FARES_MALLEK_final4/output/result_male-5-outdoor_Moment-removebg-preview_512/result_male-5-outdoor_Moment-removebg-preview_512_data.npy',allow_pickle='TRUE').item()
# D=read_dictionary['D']
